...
function resetChatHistory() {
    ...
    addMessage('bot', "Hello! I'm an AI assistant powered by Cohere. How can I help you today?");
}
...
promptButtons.forEach((button, index) => {
    ...
    button.addEventListener('click', (e) => {
        if (e.button === 0 && prompts[index]) { // Left click
...
// Temperature presets
document.querySelectorAll('.temp-preset').forEach(button => {
    button.addEventListener('click', (e) => {
